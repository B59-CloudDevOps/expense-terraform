pipeline {
    ...
    parameters {
        ...
        choice(name: 'choice', choices: ['apply', 'destroy'], description: 'Select the action')
    }
    stages {
        ...
        stage('Terraform Apply') {
            steps {
                sh "terraform ${params.environment} -var-file=env-${params.environment}/main.tfvars -auto-approve"
            }
        }
    }
}